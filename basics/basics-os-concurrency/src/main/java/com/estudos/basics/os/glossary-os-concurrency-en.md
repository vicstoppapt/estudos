**PT:** [glossary-os-concurrency.md](glossary-os-concurrency.md)

# Glossary — OS, CPU, threads, and JVM (English · PT ↔ EN)

**Layout:** one table with **English** and **Portuguese** columns; short definitions in English.

**Wider glossary (language, networking, frameworks, …):** [GLOSSARY.md](../../../../../../../../../GLOSSARY.md) at the `estudos` root. **How to run all modules:** [DOCUMENTATION.md](../../../../../../../../../DOCUMENTATION.md).

Quick index of terms used in the PT/EN pairs: [processadorcoresethreads.md](processadorcoresethreads.md) · [processadorcoresethreads-en.md](processadorcoresethreads-en.md), [processosthreadsecpu.md](processosthreadsecpu.md) · [processosthreadsecpu-en.md](processosthreadsecpu-en.md), [jvmeagendamento.md](jvmeagendamento.md) · [jvmeagendamento-en.md](jvmeagendamento-en.md).

---

## By English term (A–Z)

| English | Portuguese | Short definition (EN) |
|---------|-----------|------------------------|
...
## Referenced APIs and classes

| English context | Portuguese | Notes |
|-----------------|-----------|--------|
...
## Reverse index (Portuguese → English)

| Portuguese (usual) | English |
|-------------------|---------|
...
*(For more entries, see the main table sorted by English.)*
...
- Submodule index: [README-en.md](../../../../../../../README-en.md)

For English documentation and interviews, use the forms from the **English** column in the main table.
